...
if __name__ == '__main__':
    ...
    ll.driver = SimpleFileFactoryMethod.get_driver()  # TODO инициализировать SimpleFileDriver
    ll.read()
    print(ll)

    ll.driver = JsonFileDriverFactoryMethod.get_driver()  # TODO инициализировать JsonFileDriver
    ll.write()
